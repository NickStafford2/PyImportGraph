# ModuleName send 
make the backend json report the package name and send it to the frontend. then use that instead of deriving it manually inside ModuleName, app,tsx, and moduleName.ts

# Fix the tooltip on ModuleName
on hover i don't see it. i don't know why
